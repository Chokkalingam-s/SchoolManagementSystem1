        ...
        <div class="content">
            ...
            <div class="lbox">
                <label> ID</label><br>
                    ...
                    ?>
                <input type="text" class="input2" name="rno" style="background:#b1b1b1;" value="<?php echo $no;?>" readonly  ><br>
                <label> Student Name</label><br>
                <input type="text" class="input2" name="name"><br>
                <label> Father Name</label><br>
                <input type="text" class="input2" name="fname"><br>  
                ...
                <label>Gender</label>
                <select name="gen" required class="input2">
                ...
                <input type="text" class="input2" maxlength="10" name="pho"><br>
            </div>
            
            <div class="rbox">
            
            <label> Parent's Mail Id</label><br>
                <input type="email" class="input2" name="email"><br>
                
                <label>  Address</label><br>
                <textarea rows="3" name="addr"></textarea><br>
            
                <label>Class & Section</label><br>
                <select name="cla" required class="input2" style="width:49.5%">
                    ...
                    <select name="sec" required class="input2" style="width:49.5%">
                    <?php 
